...
path_all = 'C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/entropy_deprel_units/'
...
def process_words_in_unit(unit, data_dict):
    ...
    if all_words:
        ...
        for pos, word in enumerate(sorted_words):
            ...
            deprel = getattr(word, 'deprel', 'UNK').split('@')[0]
...
def characteristics_units(a_treebank, output_folder, file_name):
    ...
    #export_unique_types(phrase_data, os.path.join(output_folder, f'{file_name}_words_in_phrases_merged_unique_types.csv'))
    #export_unique_types(subphrase_data, os.path.join(output_folder, f'{file_name}_words_in_subphrases_merged_unique_types.csv'))
    ...
    # export_normalized_sets(phrase_data, os.path.join(output_folder, f'{file_name}_words_in_phrases_merged_normalized.csv'))
    # export_normalized_sets(subphrase_data, os.path.join(output_folder, f'{file_name}_words_in_subphrases_merged_normalized.csv'))
    # export_normalized_sets(chunk_data, os.path.join(output_folder, f'{file_name}_words_in_chunks_merged_normalized.csv'))

    export_normalized_sets(phrase_data, os.path.join(
        'C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/phrases/rel_counts/deprel_entropy_type',
        f'05{file_name}_phrases_merged_normalized_seq_unit.csv'))
    export_normalized_sets(subphrase_data, os.path.join(
        'C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/subphrases/rel_counts/deprel_entropy_type',
        f'05{file_name}_subphrases_merged_normalized_seq_unit.csv'))
    export_normalized_sets(chunk_data, os.path.join(
        'C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/chunk/rel_counts/deprel_entropy_type',
        f'05{file_name}_chunks_merged_normalized_seq_unit.csv'))

    #export_relative_entropy(phrase_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/phrases/deprel_entropy_type',
        #f'09{file_name}_phrases_merged_rel_entropy_unit.csv'))
    #export_relative_entropy(subphrase_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/subphrases/deprel_entropy_type',
        #f'09{file_name}_subphrases_merged_rel_entropy_unit.csv'))
    #export_relative_entropy(chunk_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/chunk/deprel_entropy_type',
