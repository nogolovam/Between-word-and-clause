...
path_all = 'C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/entropy_deprel_clause/'
...
def characteristics_units(a_treebank, output_folder, file_name):
    ...
    #export_unique_types(subphrase_data, os.path.join(output_folder, f'{file_name}_subphrases_in_clause_unique_types.csv'))
    ...
    #export_normalized_sets(phrase_data, os.path.join(output_folder, f'{file_name}_phrases_in_clause_normalized_seq.csv'))
    #export_normalized_sets(subphrase_data, os.path.join(output_folder, f'{file_name}_subphrases_in_clause_normalized_seq.csv'))
    ...
    #export_relative_entropy(phrase_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/phrases/deprel_entropy_type', f'08{file_name}_phrases_merged_rel_entropy_cl.csv'))
    #export_relative_entropy(subphrase_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/subphrases/deprel_entropy_type', f'08{file_name}_subphrases_merged_rel_entropy_cl.csv'))
    #export_relative_entropy(chunk_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/chunk/deprel_entropy_type', f'08{file_name}_chunks_merged_rel_entropy_cl.csv'))
