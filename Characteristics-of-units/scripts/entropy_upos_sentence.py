...
path_all = 'C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/entropy_upos_sentence/'
...
def characteristics_units(a_treebank, output_folder, file_name):
    ...
    # export_unique_types(phrase_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/phrases/upos_entropy_type', f'01{file_name}_phrases_merged_unique_types.csv'))
    # export_unique_types(subphrase_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/subphrases/upos_entropy_type', f'01{file_name}_subphrases_merged_unique_types.csv'))
    # export_unique_types(chunk_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/chunk/upos_entropy_type', f'01{file_name}_chunks_merged_unique_types.csv'))
    ...
    # export_entropy(phrase_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/phrases/upos_entropy_type', f'02{file_name}_phrases_merged_entropy.csv'))
    # export_entropy(subphrase_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/subphrases/upos_entropy_type', f'02{file_name}_subphrases_merged_entropy.csv'))
    # export_entropy(chunk_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/chunk/upos_entropy_type', f'02{file_name}_chunks_merged_entropy.csv'))
    ...
    # export_normalized_sets(main_clause_data,
    #                        os.path.join(output_folder, f'{file_name}_clauses_merged_normalized_seq.csv'))
    # export_normalized_sets(phrase_data, os.path.join(output_folder, f'{file_name}_phrases_merged_normalized_seq.csv'))
    # export_normalized_sets(subphrase_data,
    #                        os.path.join(output_folder, f'{file_name}_subphrases_merged_normalized_seq.csv'))
    # export_normalized_sets(chunk_data, os.path.join(output_folder, f'{file_name}_chunks_merged_normalized_seq.csv'))

    # --- EXPORT 3: Relative entropy ---
    #export_relative_entropy(phrase_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/phrases/upos_entropy_type', f'07{file_name}_phrases_merged_rel_entropy_sen.csv'))
    #export_relative_entropy(subphrase_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/subphrases/upos_entropy_type', f'07{file_name}_subphrases_merged_rel_entropy_sen.csv'))
    #export_relative_entropy(chunk_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/chunk/upos_entropy_type', f'07{file_name}_chunks_merged_rel_entropy_sen.csv'))


    export_normalized_sets(phrase_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/phrases/rel_counts/upos_entropy_type', f'01{file_name}_phrases_merged_normalized_seq.csv'))
    export_normalized_sets(subphrase_data,os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/subphrases/rel_counts/upos_entropy_type', f'01{file_name}_subphrases_merged_normalized_seq.csv'))
    export_normalized_sets(chunk_data, os.path.join('C:/Users/nogol/Documents/Doktorat/Analyzy/SUD/vysledky260403/Characteristics/for_plots/for_thesis/chunk/rel_counts/upos_entropy_type', f'01{file_name}_chunks_merged_normalized_seq.csv'))
